...
if(isset($_POST['HA_verify']))
{
    $email = $_POST['HA_veri_email'];
    $mob= $_POST['HA_veri_Mob'];
    ...
    if($result)
    {
        echo"<script type='text/javascript'> 
            ...
            header("Location:HA_Add_Ambulance_driver.php");
    }
    else
    {
        echo"<script type='text/javascript'> 
...
function add_ambulance()
{
	...
	var Email=document.getElementById("GA_veri_email").value;
	var mobile_no = /^\d{10}$/; 
	var mobile_no = document.getElementById("GA_veri_Mob").value;
...
function discard()
  ...
  <title>Hospital Admin - Add Driver Information</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Register Ambulance Driver</a>
        <!-- Form -->
        ...
        <div class="col-lg-8 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="HA_Add_Ambulance_driver.php" method="POST">
                  
                    <div class="col-lg-12">
                      <div class="form-group" >
                        <label class="form-control-label" for="input-username">Enter your Email-id</label>
                           <input id ="GA_veri_email" name="HA_veri_email"class="form-control" placeholder="Enter your email" type="text" required>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username" text-align="center" >10 digit Mobile Number</label>
                           <input id ="GA_veri_Mob" name="HA_veri_Mob"class="form-control" placeholder="10 digit Mobile Number" type="text" align="center" required>
                      </div>
                    </div>
					
                <div class="text-center">
                  <button id= "HA_verify" name="HA_verify" type="submit" required="true" class="btn btn-success my-4" onclick="add_ambulance()">Register ambulance driver</button>
