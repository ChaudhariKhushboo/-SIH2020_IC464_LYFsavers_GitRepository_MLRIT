...
$sql =mysqli_query($conn,"SELECT * FROM `logs` WHERE `hospital_id` = '".$id."'"); 
...
<head>
  ...
  <title>Hospital Admin Inbox - Logs</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="HA_Inbox.php">Inbox</a>
        <!-- Form -->
    ...
    <!-- Page content -->
    <div class="container mt--9 pb-5" style="max-width: 1500px;">
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <div class="row">
              <h3 class="text-white mb-0" style="margin-left: 30px;">INBOX </h3>
              ...
              <table class="table align-items-center table-dark table-flush" name="new_request_table">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">Request Accept<br>Date-Time</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      {
                        echo '
                            <td rowspan = 8>No Request for Hospital yet</td>
                        ';
                      }
