...
$amb=mysqli_query($conn,"SELECT `van_id`,`no_plate_no`,`vehicle_type`,`driver_id` FROM `van_info` WHERE `owner_id` ='".$id."' ");
...
<head>
  ...
  <title>Hospital Admin - Logs</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">LOGS</a>
    ...
    <div class="container mt--8 pb-5" style="max-width: 1600px;">
      <div class="row">
        <div class="col-lg-112 col-md-7" style="max-width:600px;">
                ...
                <div class="table-responsive">
                   ...
                   <table class="table align-items-center table-dark table-flush" name="new_request_table">
                      <thead class="thead-dark">
                        ...
                        <th scope="col">Registartion Status</th>
