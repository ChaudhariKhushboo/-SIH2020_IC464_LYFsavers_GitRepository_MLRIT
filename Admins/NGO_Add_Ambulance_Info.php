...
if(isset($_POST['NA_add_amb']))
{
    ...
    $sql="INSERT INTO `van_info`(`owner_id`,`owner_name`,`no_plate_no`,`vehicle_type`,`category`) VALUES ('$id','$ngo_nm','$no_plate','$type','private')";
...
<script>
  ...
  <title>NGO Admin - Ambulance Information</title>
  <!-- Favicon -->
 ...
 <a class="navbar-brand">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="NGO_Add_Ambulance_Info.php">Add Ambulance Information</a>
        ...
        <div class="col-lg-8 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="NGO_Add_Ambulance_Info.php" method="POST">
              ...
              <label class="form-control-label" for="input-username"> Enter Ambulance Owner Name:</label>
                            <input id="NA_amb_owner_name" name="NA_amb_owner_name" class="form-control" placeholder="Name of owner" type="text" value="<?php echo $ngo_nm ?>" required disabled>
                      </div>
                    </div>
