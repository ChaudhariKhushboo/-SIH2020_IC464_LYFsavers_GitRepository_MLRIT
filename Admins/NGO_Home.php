...
<body>
  ...
  <div class="main-content" >
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="NGO_Home.php">Dashboard</a>
              ...
              <div class="media align-items-center">
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold">
                    <label style='color:red'> NGO Ambulance Admin - </label>
   ...
   <!-- Page content -->
      ...
      <div class="row">
        <div class="col-lg-6 col-md-7" style="max-width:540px;">
      ...
      <!-- Private Admin list-->
      <div class="col-lg-6 col-md-7"  style="max-width:540px;margin-left: 2px;">
