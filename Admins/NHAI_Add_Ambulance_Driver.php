...
function NHAI_Amb_Driver_Admin()
{
  ...
  <title>NHAI Admin - Add Driver Information</title>
  <!-- Favicon -->
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="NHAI_Analysis.php">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="NHAI_Add_Ambulance_Driver.php">Add Ambulance Driver</a>
        ...
        <div class="col-lg-6 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="NHAI_Add_Ambulance_Driver.php" method="POST">
                ...
                <div class="text-center">
                  <button id="NA_add_driver" name="NA_add_driver" type="submit" required="true" class="btn btn-success my-4" onclick="NHAI_Amb_Driver_Admin()" >Add Driver</button>
