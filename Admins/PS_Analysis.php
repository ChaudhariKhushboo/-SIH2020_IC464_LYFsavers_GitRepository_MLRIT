  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid" >
     ...
     <a class="navbar-brand pt-0">
      ...
      <li class="nav-item">
            <a class="nav-link">
             <i class="ni ni-collection text-primary"></i><label name=" " id=" " onclick="hospitalwise()"> Hospitalwise Analysis</label>
            </a>
          </li>
...
<script>
function hospitalwise() {

<?php
$dataPoints = array(
  array("label"=> "Deore Accident Hospital, Dhule", "y"=> 260),
  array("label"=> "Hire Accident Hospital, Dhule", "y"=> 306),
  array("label"=> "Chaitanya Hospital, Dhule", "y"=> 200),
  array("label"=> "Siddheshwar Hospital, Dhule", "y"=> 257),
);  
?>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Hospitalwise Emergency Cases - Analysis"
  },
   axisX: {
    title: "Registered Hospitals - Deopur Police Station, Dhule"
  },
  axisY: {
...
<?php
$dataPoints = array(
  array("label"=> "Fire accidents", "y"=> 90),
  array("label"=> "Road accidents", "y"=> 57),
  array("label"=> "Electrocution", "y"=> 150),
  array("label"=> "Food poisoning", "y"=> 200),
  array("label"=> "Drowning", "y"=> 126),
  array("label"=> "Heart diseases", "y"=> 150),
  array("label"=> "Self harm/suicides", "y"=> 280),
  array("label"=> "Stroke (Brain attack)", "y"=> 100),
  array("label"=> "Falls", "y"=> 105),
  array("label"=> "Others", "y"=> 160),
);  
?>
