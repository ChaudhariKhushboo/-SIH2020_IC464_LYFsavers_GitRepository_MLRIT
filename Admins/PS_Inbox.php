...
$sql =mysqli_query($conn,"SELECT * FROM `logs` WHERE `ps_id` = '".$id."'"); 
...
<head>
  ...
  <title>Police Admin Inbox - Logs</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="PS_Inbox.php">Inbox</a>
        <!-- Form -->
              ...
              <table class="table align-items-center table-dark table-flush" name="new_request_table">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">Acknowledgement <br> Date-Time</th>
