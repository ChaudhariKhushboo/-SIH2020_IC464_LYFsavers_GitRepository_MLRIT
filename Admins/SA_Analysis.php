...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <title>Super Admin - Analysis</title>
  <!-- Favicon -->
...
<body>
     ...
     <a class="navbar-brand">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
		  ...
		  <li class="nav-item">
            <a class="nav-link">
             <i class="ni ni-collection text-primary"></i><label name=" " id=" " onclick="regional()"> Regional Analysis</label>
            </a>
          </li>
		  <!--register ambulance driver-->
		  <li class="nav-item">
            <a class="nav-link">
              <i class="ni ni-collection text-primary"></i><label name=" " id=" " onclick="areawise()">Areawise Analysis</label>
            </a>
          </li>
          <div class="dropdown">
		        <li class="nav-item">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="SA_Home.php">Dashboard</a>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span id="SA_total_PoloiceStation_admins"class="h2 font-weight-bold mb-0"></span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                        <i class="fas fa-users"></i>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Regional Emergency Cases - Analysis"
  },
   axisX: {
    title: "States"
  },
...
<?php
$dataPoints = array(
  array("label"=> "Maharashtra", "y"=> 28),
  array("label"=> "Rajasthan", "y"=> 25),
  array("label"=> "Gujarat", "y"=> 245),
  array("label"=> "Punjab", "y"=> 233),
  array("label"=> "Uttar Pradesh", "y"=> 202),
  array("label"=> "Andhra Pradesh", "y"=> 44),
  array("label"=> "Madhya Pradesh", "y"=> 504),
  array("label"=> "Sikkim", "y"=> 170),
  array("label"=> "Arunachal Pradesh", "y"=> 112),
);  
?>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  theme: "light2", // "light1", "light2", "dark1", "dark2"
  title: {
    text: "Areawise Emergency Cases - Analysis"
  },
   axisX: {
    title: ""
  },
...
<?php
$dataPoints = array(
  array("label"=> "Fire accidents", "y"=> 0),
  array("label"=> "Road accidents", "y"=> 3),
  array("label"=> "Electrocution", "y"=> 0),
  array("label"=> "Food poisoning", "y"=> 2),
  array("label"=> "Drowning", "y"=> 1),
  array("label"=> "Heart diseases", "y"=> 2),
  array("label"=> "Self harm/suicides", "y"=> 1),
  array("label"=> "Stroke (Brain attack)", "y"=> 0),
  array("label"=> "Falls", "y"=> 0),
