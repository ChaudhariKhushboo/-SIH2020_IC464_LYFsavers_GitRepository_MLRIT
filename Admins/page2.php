...
if(isset($_POST['requested']))
{
    ...
    $sql = "INSERT INTO `logs`(`amb_driver_id`,`amb_driver_name`,`amb_driver_mob`,`amb_id`,`amb_no_plate`,`category`,`req_send_date`,`req_send_time`,`no_of_patient`,`hospital_id`,`hospital_name`,`hospital_mob`,`ps_id`,`ps_name`)VALUES('$driver_id', '$driver_name', '$driver_mob', '$van_id', '$no_plate', '$vehicle_type',$date,$time ,'$ppl','$hid','$hospital_name','$mobile','$psid','$police_station')";
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid-col-10" >
      ...
      <!-- Brand -->
     <a class="navbar-brand pt-0" href="Driver_Dashboard.html">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="Driver_Dashboard.html">Dashboard</a>
        ...
        <div class="header-body">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-6">
          	...
          	<?php  echo $driver_id."<br>".$driver_name."<br>".$driver_mob."<br>".$van_id."<br>".$no_plate."<br>".$vehicle_type."<br>".$ppl."<br>".$hid."<br>".$hospital_name."<br>".$mobile."<br>".$psid."<br>".$police_station;?>
          </div>
        </div>
      </div>
    </div>
   <!-- Page content -->
   <div class="container mt--6 pb-5" style="max-width: 1250px; table-layout: fixed;">
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <div class="row">
              <h3 class="text-white mb-0" style="margin-left: 30px;">List of Nearest Hospitals<?php echo $psid?></h3>
